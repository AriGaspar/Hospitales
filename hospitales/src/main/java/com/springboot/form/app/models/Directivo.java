...
public class Directivo {
	...
	public String getTelefDirector() {
		return telefDirector;
	}
	public void setTelefDirector(String telefDirector) {
	...
	public String getTelefSubdirector() {
		return telefSubdirector;
	}
	public void setTelefSubdirector(String telefSubdirector) {
	...
	public String getTelefAdministrador() {
